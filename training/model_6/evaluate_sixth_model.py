...
from training.model_6.sixth_model_dataset import SixthModelDataset
...
def main():
    print("=" * 65)
    print("EVALUATING MODEL 6 ON TEST SPLIT")
    ...
    test_dataset = SixthModelDataset("test", augment=False)
    ...
    print("\n" + "=" * 65)
    print("MODEL 6 TEST SET EVALUATION METRICS")
    print("=" * 65)
