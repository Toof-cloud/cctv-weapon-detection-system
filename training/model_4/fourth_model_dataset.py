...
class FourthModelDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        for _, row in image_rows.iterrows():
            ...
            # Ensure strict positive width/height
        ...
        # Fallback if somehow an image had only invalid boxes
        if not boxes:
