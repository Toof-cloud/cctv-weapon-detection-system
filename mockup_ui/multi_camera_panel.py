...
class MultiCameraDialog(QWidget):
    ...
    def __init__(self, videos, parent=None):
        ...
        setup.addWidget(add)
        enhancement_heading = QFrame()
        enhancement_heading.setObjectName("cameraEnhancementHeading")
        enhancement_copy = QVBoxLayout(enhancement_heading)
        enhancement_copy.setContentsMargins(11, 9, 11, 9)
        enhancement_copy.setSpacing(3)
        enhancement_top = QHBoxLayout()
        enhancement_top.addWidget(label("Enhancement", "cameraEnhancementTitle"), 1)
        engine = label("BasicVSR++", "cameraEnhancementEngine")
        engine.setWordWrap(False)
        enhancement_top.addWidget(engine)
        enhancement_copy.addLayout(enhancement_top)
        enhancement_copy.addWidget(label("Optional · enhance before detection", "cameraSourceDetail"))
        setup.addWidget(enhancement_heading)
