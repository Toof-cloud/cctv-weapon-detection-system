...
TEST_JOBS = [
    {
        ...
        "output": ROOT / "outputs" / "fifth_model_outputs" / "knife_detection_evaluationvideo",
    },
    {
        "name": "Knife CCTV Video (NEW_KNIFE_VIDEO_11s)",
        "video": ROOT / "samples" / "NEW_KNIFE_VIDEO_11s.mp4",
        "output": ROOT / "outputs" / "fifth_model_outputs" / "knife_detection_cctv_footage",
    },
    {
        "name": "Handgun Normal Video (handgun_test-video)",
        "video": ROOT / "samples" / "handgun_test-video.mp4",
        "output": ROOT / "outputs" / "fifth_model_outputs" / "handgun_detection_cctv_footage",
    },
    {
        "name": "Handgun Staged CCTV Video (CAM02_Scene_004)",
        "video": ROOT / "samples" / "CAM02_Scene_004.mp4",
        "output": ROOT / "outputs" / "fifth_model_outputs" / "handgun_detection_staged_dataset",
    },
]
...
def main():
    print("=" * 65)
    print("STARTING MODEL 5 QUADRANT VIDEO BENCHMARK")
    ...
    print("\n" + "=" * 65)
    print("ALL 4 MODEL 5 VIDEO BENCHMARKS COMPLETED!")
    print("Outputs stored in: outputs/fifth_model_outputs/")
    print("=" * 65)
