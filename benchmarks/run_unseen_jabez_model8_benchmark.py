...
OUTPUT_BASE = ROOT / "outputs" / "unseen_jabez_model8_evaluation"
OUTPUT_BASE.mkdir(parents=True, exist_ok=True)

def run_unseen_benchmark():
    videos = sorted(list(INPUT_DIR.glob("*.mp4")))
    print("=" * 80)
    print("STARTING UNSEEN CCTV EVALUATION (MODEL 8 + INTELLIGENCE LAYER)")
    ...
    print("\n" + "=" * 80)
    print("ALL 10 UNSEEN VIDEOS EVALUATION COMPLETED!")
    print("=" * 80)
