...
TEST_JOBS = [
    {
        ...
        "output_dir": ROOT / "outputs" / "ninth_model_outputs" / "handgun_detection_staged_dataset",
    },
    {
        ...
        "output_dir": ROOT / "outputs" / "ninth_model_outputs" / "knife_detection_cctv_footage",
    },
    {
        ...
        "output_dir": ROOT / "outputs" / "ninth_model_outputs" / "knife_detection_evaluationvideo",
    },
    {
        ...
        "output_dir": ROOT / "outputs" / "ninth_model_outputs" / "handgun_detection_cctv_footage",
    },
]
...
def run_benchmark():
    print("=" * 76)
    print("STARTING MODEL 9 CCTV SURVEILLANCE INTELLIGENCE BENCHMARK")
    print(f"Model Checkpoint: {MODEL_PATH}")
    print("Features: Balanced Anchors + CCTV Hard Negatives + Directional Motion Blur")
    print("=" * 76)
    ...
    print("\n" + "=" * 76)
    print("ALL 4 MODEL 9 BENCHMARKS COMPLETED!")
    print("Outputs stored in: outputs/ninth_model_outputs/")
    print("=" * 76)
