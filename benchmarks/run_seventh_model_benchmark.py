...
TEST_JOBS = [
    {
        ...
        "output_dir": ROOT / "outputs" / "seventh_model_outputs" / "handgun_detection_staged_dataset",
    },
    {
        ...
        "output_dir": ROOT / "outputs" / "seventh_model_outputs" / "knife_detection_cctv_footage",
    },
    {
        ...
        "output_dir": ROOT / "outputs" / "seventh_model_outputs" / "knife_detection_evaluationvideo",
    },
    {
        ...
        "output_dir": ROOT / "outputs" / "seventh_model_outputs" / "handgun_detection_cctv_footage",
    },
]
...
def run_benchmark():
    print("=" * 76)
    print("STARTING MODEL 7 CCTV SURVEILLANCE INTELLIGENCE BENCHMARK")
    print(f"Model Checkpoint: {MODEL_PATH}")
    print("Features: Hard Negative Mining Weights + Small RPN Anchors + CCTV Intelligence Layer")
    print("=" * 76)
    ...
    for idx, job in enumerate(TEST_JOBS, start=1):
        ...
        # 1. Reuse pre-enhanced video if available
    ...
    print("\n" + "=" * 76)
    print("ALL 4 MODEL 7 BENCHMARKS COMPLETED!")
    print("Outputs stored in: outputs/seventh_model_outputs/")
    print("=" * 76)
